...
class getSecurity_Authenticator_FormLogin_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['App\\Service\\AccessHelper'] ?? $container->load('getAccessHelperService'));
        ...
        $d = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($b, $c, [], ($container->privates['logger'] ?? self::getLoggerService($container)));
        $d->setOptions(['login_path' => 'app_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path']);

        $instance = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($c, ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService')), new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \App\Security\LoginSuccessHandler(($container->services['router'] ?? self::getRouterService($container)), $a), ['login_path' => 'app_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false], 'main'), $d, ['login_path' => 'app_login', 'check_path' => 'app_login', 'enable_csrf' => true, 'username_parameter' => 'email', 'password_parameter' => 'password', 'use_forward' => false, 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true, 'form_only' => false]);
