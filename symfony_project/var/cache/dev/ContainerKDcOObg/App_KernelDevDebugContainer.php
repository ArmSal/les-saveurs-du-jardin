...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\AccessAdminController' => 'getAccessAdminControllerService',
            'App\\Controller\\Admin\\CommandeAdminController' => 'getCommandeAdminControllerService',
            'App\\Controller\\Admin\\ShortcutController' => 'getShortcutControllerService',
            ...
            'App\\Controller\\DocumentFolderController' => 'getDocumentFolderControllerService',
            ...
            'App\\Controller\\PortalDocumentController' => 'getPortalDocumentControllerService',
            ...
            'App\\Controller\\TransportLogistiqueController' => 'getTransportLogistiqueControllerService',
            'App\\Controller\\UserObservationController' => 'getUserObservationControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/SecurityAccessSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/src/Repository/PortalNotificationRepository.php';
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/NotificationExtension.php';
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventSubscriber\\DatabaseExceptionSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\DatabaseExceptionSubscriber'] ?? $container->load('getDatabaseExceptionSubscriberService')), 'onKernelException'], 10);
        $instance->addListener('kernel.request', [#[\Closure(name: 'App\\EventSubscriber\\SecurityAccessSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'] ?? self::getSecurityAccessSubscriberService($container)), 'onKernelRequest'], 0);
        $instance->addListener('kernel.exception', [#[\Closure(name: 'App\\EventSubscriber\\SecurityAccessSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'] ?? self::getSecurityAccessSubscriberService($container)), 'onKernelException'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\AccessAdminController', 'App\\Controller\\Admin\\CommandeAdminController', 'App\\Controller\\Admin\\ShortcutController', 'App\\Controller\\Admin\\UserAdminController', 'App\\Controller\\AgendaController', 'App\\Controller\\CartController', 'App\\Controller\\CommandeController', 'App\\Controller\\DashboardController', 'App\\Controller\\DocumentController', 'App\\Controller\\DocumentFolderController', 'App\\Controller\\HomeController', 'App\\Controller\\MaintenanceController', 'App\\Controller\\MediaController', 'App\\Controller\\NotificationController', 'App\\Controller\\PortalDocumentController', 'App\\Controller\\ProduitController', 'App\\Controller\\RHController', 'App\\Controller\\RegistrationController', 'App\\Controller\\SecurityController', 'App\\Controller\\SettingsController', 'App\\Controller\\StaticPageController', 'App\\Controller\\TransportLogistiqueController', 'App\\Controller\\UserObservationController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private 'App\EventSubscriber\SecurityAccessSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\SecurityAccessSubscriber
     */
    protected static function getSecurityAccessSubscriberService($container)
    {
        $a = ($container->privates['security.helper'] ?? self::getSecurity_HelperService($container));

        if (isset($container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'];
        }
        ...
        $instance = new \App\EventSubscriber\SecurityAccessSubscriber($a, $b);

        if (isset($container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'])) {
            return $container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'];
        }

        return $container->privates['App\\EventSubscriber\\SecurityAccessSubscriber'] = $instance;
    }

    /**
     * Gets the private 'App\Repository\PortalNotificationRepository' shared autowired service.
     *
     * @return \App\Repository\PortalNotificationRepository
     */
    protected static function getPortalNotificationRepositoryService($container)
    {
        return $container->privates['App\\Repository\\PortalNotificationRepository'] = new \App\Repository\PortalNotificationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
    ...
    protected static function getCartServiceService($container)
    {
        ...
        $instance = new \App\Service\CartService(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a);

        if (isset($container->privates['App\\Service\\CartService'])) {
            return $container->privates['App\\Service\\CartService'];
        }

        return $container->privates['App\\Service\\CartService'] = $instance;
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aIwrNsxK9z', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDebug_Security_Access_DecisionManagerService($container)
    {
        $instance = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () use ($container) {
            ...
            yield 3 => ($container->privates['.debug.security.voter.App\\Security\\Voter\\ModuleVoter'] ?? $container->load('getModuleVoterService'));
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\CleaningTaskItemRepository' => ['privates', 'App\\Repository\\CleaningTaskItemRepository', 'getCleaningTaskItemRepositoryService', true],
            'App\\Repository\\CleaningTaskRepository' => ['privates', 'App\\Repository\\CleaningTaskRepository', 'getCleaningTaskRepositoryService', true],
            'App\\Repository\\MagasinRepository' => ['privates', 'App\\Repository\\MagasinRepository', 'getMagasinRepositoryService', true],
            'App\\Repository\\ModulePermissionRepository' => ['privates', 'App\\Repository\\ModulePermissionRepository', 'getModulePermissionRepositoryService', true],
            'App\\Repository\\ObservationMonthLockRepository' => ['privates', 'App\\Repository\\ObservationMonthLockRepository', 'getObservationMonthLockRepositoryService', true],
            'App\\Repository\\PortalCategorieProduitRepository' => ['privates', 'App\\Repository\\PortalCategorieProduitRepository', 'getPortalCategorieProduitRepositoryService', true],
            'App\\Repository\\PortalCongeRepository' => ['privates', 'App\\Repository\\PortalCongeRepository', 'getPortalCongeRepositoryService', true],
            'App\\Repository\\PortalDocumentFolderRepository' => ['privates', 'App\\Repository\\PortalDocumentFolderRepository', 'getPortalDocumentFolderRepositoryService', true],
            'App\\Repository\\PortalDocumentRepository' => ['privates', 'App\\Repository\\PortalDocumentRepository', 'getPortalDocumentRepositoryService', true],
            'App\\Repository\\PortalHoraireRepository' => ['privates', 'App\\Repository\\PortalHoraireRepository', 'getPortalHoraireRepositoryService', true],
            'App\\Repository\\PortalMonthlyValidationRepository' => ['privates', 'App\\Repository\\PortalMonthlyValidationRepository', 'getPortalMonthlyValidationRepositoryService', true],
            'App\\Repository\\PortalNotificationRepository' => ['privates', 'App\\Repository\\PortalNotificationRepository', 'getPortalNotificationRepositoryService', false],
            'App\\Repository\\PortalProductRepository' => ['privates', 'App\\Repository\\PortalProductRepository', 'getPortalProductRepositoryService', true],
            'App\\Repository\\PortalShortcutRepository' => ['privates', 'App\\Repository\\PortalShortcutRepository', 'getPortalShortcutRepositoryService', true],
            'App\\Repository\\PortalWeekLockRepository' => ['privates', 'App\\Repository\\PortalWeekLockRepository', 'getPortalWeekLockRepositoryService', true],
            'App\\Repository\\RoleRepository' => ['privates', 'App\\Repository\\RoleRepository', 'getRoleRepositoryService', true],
            'App\\Repository\\TransEtLogCamionRepository' => ['privates', 'App\\Repository\\TransEtLogCamionRepository', 'getTransEtLogCamionRepositoryService', true],
            'App\\Repository\\TransEtLogRepository' => ['privates', 'App\\Repository\\TransEtLogRepository', 'getTransEtLogRepositoryService', true],
            'App\\Repository\\UserObservationRepository' => ['privates', 'App\\Repository\\UserObservationRepository', 'getUserObservationRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\CleaningTaskItemRepository' => '?',
            'App\\Repository\\CleaningTaskRepository' => '?',
            'App\\Repository\\MagasinRepository' => '?',
            'App\\Repository\\ModulePermissionRepository' => '?',
            'App\\Repository\\ObservationMonthLockRepository' => '?',
            'App\\Repository\\PortalCategorieProduitRepository' => '?',
            'App\\Repository\\PortalCongeRepository' => '?',
            'App\\Repository\\PortalDocumentFolderRepository' => '?',
            'App\\Repository\\PortalDocumentRepository' => '?',
            'App\\Repository\\PortalHoraireRepository' => '?',
            'App\\Repository\\PortalMonthlyValidationRepository' => '?',
            'App\\Repository\\PortalNotificationRepository' => '?',
            'App\\Repository\\PortalProductRepository' => '?',
            'App\\Repository\\PortalShortcutRepository' => '?',
            'App\\Repository\\PortalWeekLockRepository' => '?',
            'App\\Repository\\RoleRepository' => '?',
            'App\\Repository\\TransEtLogCamionRepository' => '?',
            'App\\Repository\\TransEtLogRepository' => '?',
            'App\\Repository\\UserObservationRepository' => '?',
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\CartExtension(($container->privates['App\\Service\\CartService'] ?? self::getCartServiceService($container))));
        $instance->addExtension(new \App\Twig\NotificationExtension($c, ($container->privates['App\\Repository\\PortalNotificationRepository'] ?? self::getPortalNotificationRepositoryService($container))));
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'google_places_api_key' => $container->getEnv('GOOGLE_PLACES_API_KEY'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'documents_directory' => (\dirname(__DIR__, 4).'/storage/documents'),
            'documents_rh_directory' => (\dirname(__DIR__, 4).'/storage/documents_rh'),
            'users_directory' => (\dirname(__DIR__, 4).'/storage/users'),
            'products_directory' => (\dirname(__DIR__, 4).'/storage/products'),
            'shortcuts_directory' => (\dirname(__DIR__, 4).'/storage/shortcuts'),
            ...
            'session.metadata.cookie_lifetime' => 3600,
